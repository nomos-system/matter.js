...
export const CommonLandmarkNamespaceNs = SemanticNamespace(
    { name: "CommonLandmarkNamespace", id: 0x11 },
    ...
    SemanticTag({ name: "PetCrate", id: 0x24 }),
    ...
    SemanticTag({ name: "WineCooler", id: 0x32 })
);

MatterDefinition.children.push(CommonLandmarkNamespaceNs);
