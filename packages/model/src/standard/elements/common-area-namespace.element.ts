...
export const CommonAreaNamespaceNs = SemanticNamespace(
    { name: "CommonAreaNamespace", id: 0x10 },
    ...
    SemanticTag({ name: "Reserved28", id: 0x28 }),
    ...
    SemanticTag({ name: "Reserved30", id: 0x30 }),
    ...
    SemanticTag({ name: "Reserved49", id: 0x49 }),
...
MatterDefinition.children.push(CommonAreaNamespaceNs);
