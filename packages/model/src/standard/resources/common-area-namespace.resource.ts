...
Resource.add({
    tag: "semanticNamespace", name: "CommonAreaNamespace", xref: "namespace§15",
    ...
    children: [
        ...
        {
            tag: "semanticTag", name: "Reserved28",
        ...
        { tag: "semanticTag", name: "Reserved30", description: "Deprecated: was Larder; use 0x3D Pantry" },
        {
        ...
        { tag: "semanticTag", name: "Reserved49", description: "Deprecated: was Restroom; use 0x06 Bathroom" },
