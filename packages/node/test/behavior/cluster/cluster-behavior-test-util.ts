...
// Defined before the namespace because My.schema references it
...
export namespace My {
    ...
    export const id = ClusterId(0x1234_fc01);
    export const name = "MyCluster" as const;
...
export const BaseBehavior = ClusterBehavior.withInterface<MyClusterTyping>().for(My, MySchema);
