...
export const TlvMeasurementAccuracy = TlvObject({
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 2.1.3.3.2
     */
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 2.1.3.3.5
     */
