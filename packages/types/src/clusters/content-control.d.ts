...
import type { ContentControl as ContentControlModel } from "@matter/model";
...
export declare namespace ContentControl {
    ...
    export interface Attributes extends Base.Attributes, Partial<OnDemandContentRatingComponent.Attributes>, Partial<ScheduledContentRatingComponent.Attributes>, Partial<ScreenTimeComponent.Attributes>, Partial<BlockUnratedComponent.Attributes>, Partial<BlockChannelsComponent.Attributes>, Partial<BlockApplicationsComponent.Attributes>, Partial<BlockContentTimeWindowComponent.Attributes> {}
    ...
    export interface Events extends ScreenTimeComponent.Events, BlockContentTimeWindowComponent.Events {}
    ...
    export const schema: typeof ContentControlModel;
