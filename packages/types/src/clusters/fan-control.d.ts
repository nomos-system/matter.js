...
import type { FanControl as FanControlModel } from "@matter/model";
...
export declare namespace FanControl {
    ...
    export interface Attributes extends Base.Attributes, Partial<MultiSpeedComponent.Attributes>, Partial<RockingComponent.Attributes>, Partial<WindComponent.Attributes>, Partial<AirflowDirectionComponent.Attributes> {}
    ...
    export const schema: typeof FanControlModel;
