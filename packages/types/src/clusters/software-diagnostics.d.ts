...
import type { SoftwareDiagnostics as SoftwareDiagnosticsModel } from "@matter/model";
...
export declare namespace SoftwareDiagnostics {
    ...
    export interface Attributes extends Base.Attributes, Partial<WatermarksComponent.Attributes> {}
    ...
    export const schema: typeof SoftwareDiagnosticsModel;
