...
import type { LevelControl as LevelControlModel } from "@matter/model";
...
export declare namespace LevelControl {
    ...
    export interface Attributes extends Base.Attributes, Partial<LightingComponent.Attributes>, Partial<NotLightingComponent.Attributes>, Partial<FrequencyComponent.Attributes> {}
    ...
    export const schema: typeof LevelControlModel;
