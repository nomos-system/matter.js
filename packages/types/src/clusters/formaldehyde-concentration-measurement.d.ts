...
import type { FormaldehydeConcentrationMeasurement as FormaldehydeConcentrationMeasurementModel } from "@matter/model";
...
export declare namespace FormaldehydeConcentrationMeasurement {
    ...
    export const schema: typeof FormaldehydeConcentrationMeasurementModel;
    ...
    /**
     * @deprecated Use the cluster namespace directly (e.g. `FormaldehydeConcentrationMeasurement` instead of
...
export interface FormaldehydeConcentrationMeasurement extends ClusterTyping { Attributes: FormaldehydeConcentrationMeasurement.Attributes; Features: FormaldehydeConcentrationMeasurement.Features; Components: FormaldehydeConcentrationMeasurement.Components }
