...
import type { GeneralCommissioning as GeneralCommissioningModel } from "@matter/model";
...
export declare namespace GeneralCommissioning {
    ...
    export interface Attributes extends Base.Attributes, Partial<TermsAndConditionsComponent.Attributes> {}
    ...
    export const schema: typeof GeneralCommissioningModel;
