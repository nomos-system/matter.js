...
import type { EnergyEvse as EnergyEvseModel } from "@matter/model";
...
export declare namespace EnergyEvse {
    ...
    export interface Attributes extends Base.Attributes, Partial<V2XComponent.Attributes>, Partial<ChargingPreferencesComponent.Attributes>, Partial<SoCReportingComponent.Attributes>, Partial<PlugAndChargeComponent.Attributes> {}
    export interface Commands extends Base.Commands, V2XComponent.Commands, ChargingPreferencesComponent.Commands {}
    export interface Events extends Base.Events, RfidComponent.Events {}
    ...
    export const schema: typeof EnergyEvseModel;
