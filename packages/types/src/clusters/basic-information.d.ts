...
/**
 * Definitions for the BasicInformation cluster.
 *
...
export declare namespace BasicInformation {
     ...
     */
    export const id: ClusterId & 0x0028;
    ...
    /**
     * Events that may appear in {@link BasicInformation}.
     *
     * Some properties may be optional if device support is not mandatory.
     */
     ...
     */
    export interface CapabilityMinima {
        /**
    ...
    export const Typing: BasicInformation;
}
...
export interface BasicInformation extends ClusterTyping {
    Attributes: BasicInformation.Attributes;
    Events: BasicInformation.Events;
    Components: BasicInformation.Components;
}
