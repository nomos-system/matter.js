...
import type {
    NitrogenDioxideConcentrationMeasurement as NitrogenDioxideConcentrationMeasurementModel
} from "@matter/model";
...
export declare namespace NitrogenDioxideConcentrationMeasurement {
    ...
    export const schema: typeof NitrogenDioxideConcentrationMeasurementModel;
