 ...
 */
export declare namespace NitrogenDioxideConcentrationMeasurement {
    /**
     * The Matter protocol cluster identifier.
     */
    export const id: ClusterId & 0x0413;

    /**
     * Textual cluster identifier.
     */
    export const name: "NitrogenDioxideConcentrationMeasurement";
    ...
    /**
     * Canonical metadata for the NitrogenDioxideConcentrationMeasurement cluster.
     *
    ...
    export const Typing: NitrogenDioxideConcentrationMeasurement;
}
...
export interface NitrogenDioxideConcentrationMeasurement extends ClusterTyping {
    Attributes: NitrogenDioxideConcentrationMeasurement.Attributes;
    Features: NitrogenDioxideConcentrationMeasurement.Features;
    Components: NitrogenDioxideConcentrationMeasurement.Components;
}
