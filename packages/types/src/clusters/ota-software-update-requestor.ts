...
import { AccessLevel, OtaSoftwareUpdateRequestor as OtaSoftwareUpdateRequestorModel } from "@matter/model";
...
export namespace OtaSoftwareUpdateRequestor {
    ...
    export declare const Typing: OtaSoftwareUpdateRequestor;
}
