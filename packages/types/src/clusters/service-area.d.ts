...
import type { ServiceArea as ServiceAreaModel } from "@matter/model";
...
export declare namespace ServiceArea {
    ...
    export interface Attributes extends Base.Attributes, Partial<MapsComponent.Attributes>, Partial<ProgressReportingComponent.Attributes> {}
    ...
    export const schema: typeof ServiceAreaModel;
