...
import { Thermostat as ThermostatModel } from "@matter/model";
...
export namespace Thermostat {
    ...
    export type Cluster = typeof Thermostat;
    export declare const Cluster: Cluster;

    /**
     * @deprecated Use the cluster namespace directly (e.g. `Thermostat` instead of `Thermostat.Complete`)
     */
    export type Complete = typeof Thermostat;
