...
import type { DishwasherAlarm as DishwasherAlarmModel } from "@matter/model";
...
export declare namespace DishwasherAlarm {
    ...
    export const schema: typeof DishwasherAlarmModel;
    ...
    /**
     * @deprecated Use the cluster namespace directly (e.g. `DishwasherAlarm` instead of `DishwasherAlarm.Complete`)
     */
