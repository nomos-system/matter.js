...
export declare namespace OzoneConcentrationMeasurement {
     ...
     */
    export const id: ClusterId & 0x0415;
    ...
    /**
     * Canonical metadata for the OzoneConcentrationMeasurement cluster.
     *
    ...
    /**
     * Attributes that may appear in {@link OzoneConcentrationMeasurement}.
     *
...
export interface OzoneConcentrationMeasurement extends ClusterTyping {
    Attributes: OzoneConcentrationMeasurement.Attributes;
    Features: OzoneConcentrationMeasurement.Features;
    Components: OzoneConcentrationMeasurement.Components;
}
