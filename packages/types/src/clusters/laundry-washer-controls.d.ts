...
import type { LaundryWasherControls as LaundryWasherControlsModel } from "@matter/model";
...
export declare namespace LaundryWasherControls {
    ...
    export interface Attributes extends Partial<SpinComponent.Attributes>, Partial<RinseComponent.Attributes> {}
    ...
    export const schema: typeof LaundryWasherControlsModel;
