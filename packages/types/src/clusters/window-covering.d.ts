...
import type { WindowCovering as WindowCoveringModel } from "@matter/model";
...
export declare namespace WindowCovering {
    ...
    export interface Attributes extends Base.Attributes, Partial<LiftAndPositionAwareLiftAndAbsolutePositionComponent.Attributes>, Partial<TiltAndPositionAwareTiltAndAbsolutePositionComponent.Attributes>, Partial<LiftComponent.Attributes>, Partial<TiltComponent.Attributes>, Partial<LiftAndPositionAwareLiftComponent.Attributes>, Partial<TiltAndPositionAwareTiltComponent.Attributes> {}
    ...
    export const schema: typeof WindowCoveringModel;
