...
import type { RadonConcentrationMeasurement as RadonConcentrationMeasurementModel } from "@matter/model";
import type { ClusterId } from "../datatype/ClusterId.js";

/**
 * Definitions for the RadonConcentrationMeasurement cluster.
 */
export declare namespace RadonConcentrationMeasurement {
    /**
     * {@link RadonConcentrationMeasurement} always supports these elements.
     */
    ...
    /**
     * {@link RadonConcentrationMeasurement} supports these elements if it supports feature "NumericMeasurement".
     */
    ...
    /**
     * {@link RadonConcentrationMeasurement} supports these elements if it supports feature "PeakMeasurement".
     */
    ...
    /**
     * {@link RadonConcentrationMeasurement} supports these elements if it supports feature "AverageMeasurement".
     */
    ...
    /**
     * {@link RadonConcentrationMeasurement} supports these elements if it supports feature "LevelIndication".
     */
    ...
    export const schema: typeof RadonConcentrationMeasurementModel;
    ...
    /**
     * @deprecated Use the cluster namespace directly (e.g. `RadonConcentrationMeasurement` instead of
     * `RadonConcentrationMeasurement.Complete`)
     */
    export const Complete: typeof RadonConcentrationMeasurement;

    export const Typing: RadonConcentrationMeasurement;
}

export declare const RadonConcentrationMeasurementCluster: typeof RadonConcentrationMeasurement;
export interface RadonConcentrationMeasurement extends ClusterTyping { Attributes: RadonConcentrationMeasurement.Attributes; Features: RadonConcentrationMeasurement.Features; Components: RadonConcentrationMeasurement.Components }
