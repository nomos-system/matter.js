...
export declare namespace RadonConcentrationMeasurement {
     ...
     */
    export const id: ClusterId & 0x042f;
...
export interface RadonConcentrationMeasurement extends ClusterTyping {
    Attributes: RadonConcentrationMeasurement.Attributes;
    Features: RadonConcentrationMeasurement.Features;
    Components: RadonConcentrationMeasurement.Components;
}
