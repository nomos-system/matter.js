...
export declare namespace DishwasherMode {
     ...
     */
    export const id: ClusterId & 0x0059;
    ...
    /**
     * Canonical metadata for the DishwasherMode cluster.
     *
    ...
    /**
     * {@link DishwasherMode} always supports these elements.
     */
    ...
    /**
     * Commands that may appear in {@link DishwasherMode}.
     */
    ...
    export const Typing: DishwasherMode;
}
...
export interface DishwasherMode extends ClusterTyping {
    Attributes: DishwasherMode.Attributes;
    Commands: DishwasherMode.Commands;
    Features: DishwasherMode.Features;
    Components: DishwasherMode.Components;
}
