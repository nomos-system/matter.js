...
/**
 * Definitions for the OperationalState cluster.
 *
 ...
 *
 * This cluster defines common states, scoped to this cluster (e.g. Stopped, Running, Paused, Error). A derived cluster
 * specification may define more states scoped to the derivation. Manufacturer specific states are supported in this
 * cluster and any derived clusters thereof. When defined in a derived instance, such states are scoped to the
 * derivation.
 *
...
export declare namespace OperationalState {
     ...
     */
    export const id: ClusterId & 0x0060;

    /**
     * Textual cluster identifier.
     */
    export const name: "OperationalState";
    ...
    /**
     * Canonical metadata for the OperationalState cluster.
     *
    ...
    /**
     * {@link OperationalState} always supports these elements.
     */
    ...
    /**
     * Attributes that may appear in {@link OperationalState}.
     *
    ...
    /**
     * Commands that may appear in {@link OperationalState}.
     */
    ...
    /**
     * Events that may appear in {@link OperationalState}.
     *
     * Some properties may be optional if device support is not mandatory.
     */
     ...
     */
    export class OperationalStateStruct {
     ...
     * @see {@link MatterSpecification.v151.Cluster} § 1.14.7.2
     */
    export class OperationCompletionEvent {
    ...
    export const Typing: OperationalState;
}
...
export interface OperationalState extends ClusterTyping {
    Attributes: OperationalState.Attributes;
    Commands: OperationalState.Commands;
    Events: OperationalState.Events;
    Components: OperationalState.Components;
}
