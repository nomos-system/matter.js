...
import type { Descriptor as DescriptorModel } from "@matter/model";
...
export declare namespace Descriptor {
    ...
    export interface Attributes extends Base.Attributes, Partial<TagListComponent.Attributes> {}
    ...
    export const schema: typeof DescriptorModel;
