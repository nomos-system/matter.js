...
/**
 * Definitions for the Pm1ConcentrationMeasurement cluster.
 */
export declare namespace Pm1ConcentrationMeasurement {
    /**
     * The Matter protocol cluster identifier.
     */
    export const id: ClusterId & 0x042c;

    /**
     * Textual cluster identifier.
     */
    export const name: "Pm1ConcentrationMeasurement";
    ...
    /**
     * Canonical metadata for the Pm1ConcentrationMeasurement cluster.
     *
    ...
    /**
     * These are optional features supported by Pm1ConcentrationMeasurementCluster.
     *
     ...
     * @deprecated Use {@link Pm1ConcentrationMeasurement}.
     */
    export const Complete: typeof Pm1ConcentrationMeasurement;

    export const Typing: Pm1ConcentrationMeasurement;
}

/**
 * @deprecated Use {@link Pm1ConcentrationMeasurement}.
 */
export declare const Pm1ConcentrationMeasurementCluster: typeof Pm1ConcentrationMeasurement;

export interface Pm1ConcentrationMeasurement extends ClusterTyping {
    Attributes: Pm1ConcentrationMeasurement.Attributes;
    Features: Pm1ConcentrationMeasurement.Features;
    Components: Pm1ConcentrationMeasurement.Components;
}
