...
import type { Pm1ConcentrationMeasurement as Pm1ConcentrationMeasurementModel } from "@matter/model";
...
export declare namespace Pm1ConcentrationMeasurement {
    ...
    export const schema: typeof Pm1ConcentrationMeasurementModel;
    ...
    /**
     * @deprecated Use the cluster namespace directly (e.g. `Pm1ConcentrationMeasurement` instead of
     * `Pm1ConcentrationMeasurement.Complete`)
     */
