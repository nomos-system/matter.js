...
import type { ThreadNetworkDirectory as ThreadNetworkDirectoryModel } from "@matter/model";
...
export declare namespace ThreadNetworkDirectory {
    ...
    export namespace Base {
        export interface Attributes {
             ...
             */
            readonly threadNetworks: ThreadNetwork[];
    ...
    export const schema: typeof ThreadNetworkDirectoryModel;
    ...
    /**
     * @deprecated Use the cluster namespace directly (e.g. `ThreadNetworkDirectory` instead of
     * `ThreadNetworkDirectory.Complete`)
     */
...
export interface ThreadNetworkDirectory extends ClusterTyping { Attributes: ThreadNetworkDirectory.Attributes; Commands: ThreadNetworkDirectory.Commands; Components: ThreadNetworkDirectory.Components }
