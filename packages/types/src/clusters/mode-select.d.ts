...
import type { ModeSelect as ModeSelectModel } from "@matter/model";
...
export declare namespace ModeSelect {
    ...
    export interface Attributes extends Base.Attributes, Partial<OnOffComponent.Attributes> {}
    ...
    export const schema: typeof ModeSelectModel;
