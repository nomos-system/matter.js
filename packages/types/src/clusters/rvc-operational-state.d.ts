...
import type { OperationalState as OperationalStateNamespace } from "./operational-state.js";
...
export declare namespace RvcOperationalState {
     ...
     */
    export const id: ClusterId & 0x0061;

    /**
     * Textual cluster identifier.
     */
    export const name: "RvcOperationalState";
    ...
    /**
     * Canonical metadata for the RvcOperationalState cluster.
     *
    ...
    /**
     * Commands that may appear in {@link RvcOperationalState}.
     */
    ...
    export const Typing: RvcOperationalState;
}
...
export interface RvcOperationalState extends ClusterTyping {
    Attributes: RvcOperationalState.Attributes;
    Commands: RvcOperationalState.Commands;
    Events: RvcOperationalState.Events;
    Components: RvcOperationalState.Components;
}
