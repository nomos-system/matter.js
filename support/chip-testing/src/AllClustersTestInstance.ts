        ...
        const endpoint1 = new Endpoint(
            OnOffLightDevice.with(
                ...
                DoorLockServer.with(
                    ...
                    DoorLock.Feature.DoorPositionSensor,
            ...
            ),
            {
                ...
                doorLock: {
                    ...
                    autoRelockTime: 60,
                    language: "en",
                    soundVolume: DoorLock.SoundVolume.Silent,
                    ledSettings: DoorLock.LedSetting.NoLedSignal,
                    defaultConfigurationRegister: {},
                    enableLocalProgramming: true,
                    localProgrammingFeatures: {
                        addUsersCredentialsSchedules: true,
                        modifyUsersCredentialsSchedules: true,
                        clearUsersCredentialsSchedules: true,
                        adjustSettings: true,
                    },
                    enableOneTouchLocking: false,
                    enableInsideStatusLed: false,
                    enablePrivacyModeButton: false,
                },
                energyEvseMode: {
                    supportedModes: [
                        {
                ...
                thermostat: {
                    ...
                    outdoorTemperature: 1500,
                    occupancy: { occupied: true },
                    absMinHeatSetpointLimit: 700,
                    minHeatSetpointLimit: 700, // 1800
                    maxHeatSetpointLimit: 3000, //2800,
                    absMaxHeatSetpointLimit: 3000,
                    absMinCoolSetpointLimit: 1600,
                    minCoolSetpointLimit: 1600, //2000,
                    maxCoolSetpointLimit: 3200, //3000,
                    ...
                    presetTypes: [
                        {
                            presetScenario: Thermostat.PresetScenario.UserDefined,
                            numberOfPresets: 1,
                            presetTypeFeatures: {
                                automatic: true,
                                supportsNames: true,
                    ...
                    presets: [
                        {
                            presetHandle: Bytes.fromString("UserDef"),
                            presetScenario: Thermostat.PresetScenario.UserDefined,
                            name: "UD",
                        ...
                        {
                            presetHandle: Bytes.fromString("TestOcc"),
                            presetScenario: Thermostat.PresetScenario.Occupied,
                            name: "Occ",
                            coolingSetpoint: 2600,
                            heatingSetpoint: 2000,
